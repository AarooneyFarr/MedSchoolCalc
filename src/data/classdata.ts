...
const medSchoolData: MedSchool[] = [
    ...
    },
    {
        ...
        requiredClasses: [
            ...
            name: "Genetics",
            required: 'recommended',
            notes: "Recommended for students interested in advanced biology coursework.",
            labRequired: false
            },
            {
            name: "Cell Bio",
            required: 'recommended',
            notes: "Recommended course with emphasis on molecular biology and cellular processes.",
            labRequired: false
            },
            {
            name: "Physiology",
    ...
    },
    {
        ...
        requiredClasses: [
            ...
            name: "Genetics",
            required: 'recommended',
            notes: "Recommended for students interested in advanced biological sciences.",
            labRequired: false
            },
            {
            name: "Cell Bio",
            required: 'no',
            notes: "Not required but may be beneficial for deeper understanding of biology.",
            labRequired: false
            },
            {
            name: "Physiology",
            required: 'no',
            notes: "Not required but recommended for students focusing on human systems.",
            labRequired: false
            },
            {
            name: "Gen Chem 1",
            ...
            name: "Organic Chem 1",
            required: 'yes',
            notes: "Fundamental organic chemistry with emphasis on reactions and mechanisms.",
            labRequired: true,
            apAccepted: false
            },
            {
            name: "Organic Chem 2",
            required: 'no',
            notes: "Not required but may provide strong foundational knowledge for biochemistry.",
            labRequired: false
            },
            {
            name: "Biochem",
            ...
            name: "Physics 2",
            required: 'yes',
            notes: "Continuation of Physics 1, covering electricity, magnetism, and optics.",
            labRequired: true,
            apAccepted: false
            },
            {
            ...
            name: "English Lit",
            required: 'yes',
            notes: "Recommended to develop strong analytical and communication skills."
            },
            {
            name: "Calc 1",
            required: 'no',
            notes: "Not required but may be helpful for students interested in quantitative sciences."
            },
            {
            name: "Calc 2",
            required: 'recommended',
            notes: "Recommended for students interested in quantitative sciences or research."
            },
            {
            name: "Statistics",
            required: 'yes',
    ...
    },
    {
        ...
        generalNotes: "Strong focus on research and interdisciplinary studies. Laboratory courses emphasized for most science prerequisites.",
        requiredClasses: [
            {
            name: "Gen Bio 1",
            required: 'yes',
            ...
            name: "Gen Bio 2",
            required: 'yes',
            notes: "Continuation of introductory biology with emphasis on organismal biology. Lab component required.",
            labRequired: true,
            apAccepted: false
            },
            {
            ...
            name: "Gen Chem 2",
            required: 'yes',
            notes: "Second semester of general chemistry with a lab component required.",
            labRequired: true,
            apAccepted: true
            },
            {
            ...
            name: "Organic Chem 2",
            required: 'no',
            notes: "Not required but may strengthen foundational knowledge in chemistry.",
            labRequired: false
            },
            {
            name: "Biochem",
            required: 'yes',
            notes: "One semester of biochemistry recommended. Lab component is encouraged.",
            labRequired: true,
            ...
            name: "Physics 2",
            required: 'yes',
            notes: "Continuation of introductory physics with a lab component required.",
            labRequired: true,
            apAccepted: false
            },
            {
            name: "English Comp",
            required: 'yes',
            notes: "Required for developing strong writing and communication skills."
            },
            {
            name: "English Lit",
            required: 'no',
            notes: "Not required but may be beneficial for developing analytical skills."
            },
            {
            name: "Calc 1",
            required: 'yes',
            ...
            name: "Calc 2",
            required: 'no',
            notes: "Not required but recommended for students interested in quantitative sciences."
            },
            {
            name: "Statistics",
            required: 'recommended',
            notes: "Recommended for students interested in research and data analysis.",
    ...
    },
    {
        ...
        generalNotes: "Emphasizes foundational science coursework with a strong focus on research and clinical preparation.",
        requiredClasses: [
            {
            name: "Gen Bio 1",
            required: 'yes',
            notes: "Introductory biology with emphasis on molecular and cellular biology.",
            labRequired: true,
            apAccepted: false
            },
            {
            name: "Gen Bio 2",
            required: 'yes',
            notes: "Continuation of introductory biology, focusing on organismal biology and systems.",
            labRequired: true,
            apAccepted: false
            },
            {
            name: "Genetics",
            required: 'no',
            notes: "Not required but may provide additional depth in biological sciences."
            },
            {
            name: "Cell Bio",
            required: 'no',
            ...
            name: "Physiology",
            required: 'no',
            notes: "Not required but may be beneficial for students interested in human systems."
            },
            {
            name: "Gen Chem 1",
            required: 'yes',
            notes: "Introductory general chemistry focusing on atomic structure, bonding, and basic reactions.",
            labRequired: true,
            apAccepted: true
            },
            {
            name: "Gen Chem 2",
            required: 'yes',
            notes: "Second semester of general chemistry covering equilibrium, thermodynamics, and acid-base reactions.",
            labRequired: true,
            apAccepted: true
            },
            {
            name: "Organic Chem 1",
            required: 'yes',
            notes: "Fundamental organic chemistry covering reactions and mechanisms.",
            labRequired: true,
            apAccepted: false
            },
            {
            ...
            name: "Biochem",
            required: 'yes',
            notes: "One semester of biochemistry focusing on molecular biology and metabolism.",
            labRequired: false
            },
            {
            name: "Physics 1",
            required: 'yes',
            notes: "Introductory physics covering mechanics and thermodynamics. Lab component required.",
            labRequired: true,
            apAccepted: false
            },
            {
            name: "Physics 2",
            required: 'yes',
            notes: "Continuation of introductory physics focusing on electricity, magnetism, and optics.",
            labRequired: true,
            apAccepted: false
            },
            {
            name: "English Comp",
            required: 'yes',
            notes: "Required for developing critical writing and analytical skills."
            },
            {
            name: "English Lit",
            required: 'no',
            notes: "Not required but may be beneficial for strengthening communication skills."
            },
            {
            name: "Calc 1",
            required: 'yes',
            ...
            name: "Calc 2",
            required: 'no',
            notes: "Not required but recommended for students interested in research or quantitative sciences."
            },
            {
            name: "Statistics",
            required: 'recommended',
            notes: "Recommended for students interested in data analysis and research.",
            alternateOptions: ["Biostatistics", "Data Analysis"]
            },
            {
            name: "Psychology",
    ...
    },
    {
        ...
        generalNotes: "Focus on rigorous foundational science coursework with opportunities for interdisciplinary studies. Research experience highly valued.",
        requiredClasses: [
          {
            name: "Gen Bio 1",
            required: 'yes',
          ...
          },
          {
            name: "Gen Chem 1",
            required: 'yes',
            notes: "General chemistry focusing on atomic structure, bonding, and basic reactions.",
            labRequired: true,
            apAccepted: true
          },
          {
